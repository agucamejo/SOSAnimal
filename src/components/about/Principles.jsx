           ...
           <div className='cards-container'>
                <div className='cards'>
                    ...
                    <div className='bg-green img-text-container'>
                        <img src="/aboutImg/perro-principles.webp" alt="Imagen de un perro" />
                ...
                <div className='cards'>
                    ...
                    <div className='bg-orange img-text-container'>
                        <img src="/aboutImg/gato-principles.webp" alt="Imagen de una gata" />
                ...
                <div className='cards'>
                    ...
                    <div className='bg-pink img-text-container'>
                        <img src="/aboutImg/cachorrito-principles.webp" alt="Imagen de un perro cachorro" />
